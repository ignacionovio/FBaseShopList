            ...
            right: [
                {
                    onPress: () => {
                        Alert.alert(
                            ...
                            'Borrar '+ item.text + '?',
                            [
                                {text: 'Si', onPress: () => console.log(item.text), style: 'cancel'},
        ...
        right: [
            {
                onPress: () => {
                    Alert.alert(
                        ...
                        'Borro?',
                        [
                            {text: 'Si', onPress: () => console.log('cancel pressed'), style: 'cancel'},
                            {text: 'No', onPress: () => console.log('Yes pressed'), style: 'confirm'}
                        ],
                        {cancelable: true}
                    );
                },
